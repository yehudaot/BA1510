...
namespace mfe_gui
{
    public class GeneralCalibrationTable : CalibrationTable
    {
        ...
        public UInt16 BOOT_WAIT_TIME_USEC;
        ...
        public override byte[] asByteArray()
        {
            ...
            BitConverter.GetBytes(REV_TRESH).CopyTo(b, 8);
            ...
            BitConverter.GetBytes(BOOT_WAIT_TIME_USEC).CopyTo(b, 20);
            BitConverter.GetBytes(TX_ON_TIMING_USEC).CopyTo(b, 22);
            BitConverter.GetBytes(TX_OFF_TIMING_USEC).CopyTo(b, 24);
            BitConverter.GetBytes(PA_ON_TIMING_USEC).CopyTo(b, 26);
            BitConverter.GetBytes(PA_OFF_TIMING_USEC).CopyTo(b, 28);
            BitConverter.GetBytes(ANT_SEL_TIMING_USEC).CopyTo(b, 30);
            BitConverter.GetBytes(FWD_SAMP_TIMING_USEC).CopyTo(b, 32);
            BitConverter.GetBytes(REV_SAMP_TIMING_USEC).CopyTo(b, 34);
            BitConverter.GetBytes(INP_PWR_SAMP_TIMING_USEC).CopyTo(b, 36);
            return b;
        }
        ...
        public override void fromByteArray(byte [] rawData)
        {
            ...
            REV_TRESH = BitConverter.ToUInt16(rawData, 8);
            ...
            BOOT_WAIT_TIME_USEC = BitConverter.ToUInt16(rawData, 20);
            TX_ON_TIMING_USEC = BitConverter.ToUInt16(rawData, 22);
            TX_OFF_TIMING_USEC = BitConverter.ToUInt16(rawData, 24);
            PA_ON_TIMING_USEC = BitConverter.ToUInt16(rawData, 26);
            PA_OFF_TIMING_USEC = BitConverter.ToUInt16(rawData, 28);
            ANT_SEL_TIMING_USEC = BitConverter.ToUInt16(rawData, 30);
            FWD_SAMP_TIMING_USEC = BitConverter.ToUInt16(rawData, 32);
            REV_SAMP_TIMING_USEC = BitConverter.ToUInt16(rawData, 34);
            INP_PWR_SAMP_TIMING_USEC = BitConverter.ToUInt16(rawData, 36);
        }
    }
}
